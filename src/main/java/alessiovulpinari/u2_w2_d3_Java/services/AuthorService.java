...
import alessiovulpinari.u2_w2_d3_Java.exceptions.BadRequestException;
import alessiovulpinari.u2_w2_d3_Java.exceptions.NotFoundException;
import alessiovulpinari.u2_w2_d3_Java.repositories.AuthorRepository;
...
public class AuthorService {
    ...
    public Author save(Author newAuthor) {
        ...
        this.authorRepository.findByNameAndSurname(newAuthor.getName(), newAuthor.getSurname()).ifPresent(
                author -> {throw new BadRequestException("Esiste già un autore con nome e cognome: "
